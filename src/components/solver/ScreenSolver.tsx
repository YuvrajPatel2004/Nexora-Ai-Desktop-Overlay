  ...
  return (
    <div className="flex flex-col h-full bg-black overflow-hidden font-sans">
      ...
      <div className="p-2.5 bg-zinc-950 border-b border-white/10 space-y-2">
        <div className="flex items-center justify-between gap-1">
          ...
          <select
            ...
            className="bg-zinc-900 border border-white/10 text-white text-[11px] rounded-lg px-2 py-1 focus:outline-none focus:border-white font-mono"
          >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-1.5 py-1.5 rounded-lg bg-white text-black hover:bg-zinc-200 font-bold text-xs transition-all shadow"
          >
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-zinc-300 hover:text-white text-xs transition-colors"
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-white/10 text-zinc-300 hover:text-white text-xs transition-colors flex items-center gap-1"
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        ...
        {activeImage ? (
          <div className="relative rounded-lg overflow-hidden border border-white/15 bg-black/60 group max-h-40">
            ...
            <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
              <button
                ...
                disabled={isSolving}
                className="px-3 py-1 rounded-lg bg-white text-black font-bold text-xs flex items-center gap-1 hover:bg-zinc-200 transition-all shadow"
              >
              ...
              <button
                ...
                className="px-3 py-1 rounded-lg bg-rose-500 text-white font-bold text-xs hover:bg-rose-600 transition-all"
              >
                Clear
              </button>
            </div>
          ...
          <div className="flex flex-col items-center justify-center p-6 border border-dashed border-white/15 rounded-xl text-center space-y-2">
            <div className="p-3 rounded-full bg-white/5 text-zinc-300 border border-white/10">
              <Crop className="w-6 h-6" />
            </div>
            <p className="text-xs text-zinc-200 font-medium">No Screen Snip Active</p>
            <p className="text-[11px] text-zinc-400 max-w-xs leading-relaxed">
              Press <code className="text-white bg-white/10 px-1 py-0.5 rounded">Ctrl+Shift+S</code> to snip any code, LeetCode problem, or diagram on your desktop.
            </p>
          </div>
        )}
        ...
        {(solution || isSolving) && (
          <div className="bg-zinc-950 rounded-xl p-3.5 space-y-2 border border-white/10 relative">
            <div className="flex items-center justify-between border-b border-white/10 pb-2">
              ...
              {solution && !isSolving && (
                <button
                  onClick={handleCopy}
                  className="flex items-center gap-1 px-2.5 py-1 rounded bg-zinc-900 hover:bg-zinc-800 text-zinc-300 hover:text-white border border-white/10 text-xs transition-colors"
                >
                  {copied ? (
                    <>
